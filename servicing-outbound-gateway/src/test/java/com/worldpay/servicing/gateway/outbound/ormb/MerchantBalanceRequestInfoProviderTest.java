...
public class MerchantBalanceRequestInfoProviderTest {

  @InjectMocks
  private MerchantBalanceRequestInfoProvider underTest;
  ...
  public void testGetSpecificPath() {
    String expectedPath = "Ser130/getMerchantBalance/params";
